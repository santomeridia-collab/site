    ...
    <footer className="border-t border-border bg-secondary/30">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Column 1: About */}
          <div>
            <h3 className="text-lg text-[#132c54] font-semibold mb-4">About Santomeridia</h3>
          ...
          {/* Column 2: Divisions */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#132c54]">Our Divisions</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <Link to="/smit" className="hover:text-primary transition-smooth">
                  SMIT
                </Link>
              </li>
              <li>
                <Link to="/smile" className="hover:text-primary transition-smooth">
                  SMILE
                </Link>
              </li>
              <li>
                <Link to="/smss" className="hover:text-primary transition-smooth">
                  SMS²
                </Link>
              </li>
              <li>
                <Link to="/smrd" className="hover:text-primary transition-smooth">
                  SMRD
                </Link>
              </li>
              <li>
          ...
          {/* Column 3: Corporate */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#132c54]">Corporate Governance</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#132c54]">Stay Connected</h3>
            <div className="space-y-3">
              <div className="flex gap-2">
                ...
                <Button
                  size="sm"
                  className="bg-blue-950 hover:bg-blue-850 text-white"
                >
                  Subscribe
                </Button>
              </div>
        ...
        <div className="flex justify-center space-x-4 mb-8">
          <a
            href="https://www.linkedin.com/company/santomeridia-research-labs-pvt-ltd/"
            target="_blank"
        ...
        <div className="border-t border-border pt-6 text-center">
          <p className="text-xs sm:text-sm text-muted-foreground mb-2 text-center">
            ...
            © 2025 Santomeridia Research Labs Pvt. Ltd. | CIN: U85499KL2025PTC098671 |  An initiative of Santomeridia Global
          ...
          <p className="text-xs sm:text-sm text-muted-foreground flex items-center justify-center gap-2 flex-wrap text-center">
